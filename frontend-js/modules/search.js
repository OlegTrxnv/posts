  ...
  renderResultsHTML(posts) {
    if (posts.length) {
      ...
      ${posts
        ...
        <span class="text-muted small">${post.author.username} on ${
            postDate.getMonth() + 1
      ...
      this.resultsArea.innerHTML = `<p class="alert alert-danger text-center shadow-sm">Sorry, no results for your search</p>`;
    }
    this.hideLoaderIcon();
  ...
  injectHTML() {
    ...
    <div class="search-overlay-top shadow-sm">
      <div class="container container--narrow">
        ...
        <input type="text" id="live-search-field" class="live-search-field" placeholder="looking  for...">
